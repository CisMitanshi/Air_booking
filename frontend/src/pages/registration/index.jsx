                ...
                <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
                    ...
                    <div className="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                        <form onSubmit={handleSubmit}>
                            <div>
                                <label className="block font-medium text-sm text-gray-700" htmlFor="email">User Name</label>
                                <input
                                    type='text'
                                    name='username'
                                    value={username}
                            ...
                            <div>
                                <label className="block font-medium text-sm text-gray-700 mt-4" htmlFor="email">Email</label>
                                <input
                                    type='email'
                                    name='email'
                                    value={email}
                            ...
                            <div className="flex items-center justify-end mt-4">
                                {/* <a href="{{ route('password.request') }}" className="hover:underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Forgot your password?</a> */}
